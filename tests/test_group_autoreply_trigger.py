...
class ReplyGateTests(unittest.TestCase):
    def test_reply_to_channel_post_does_not_require_mention(self) -> None:
        message = types.SimpleNamespace(
            reply_to_message=types.SimpleNamespace(
                from_user=None,
                is_automatic_forward=True,
                sender_chat=types.SimpleNamespace(type=group.ChatType.CHANNEL),
    ...
    def test_reply_to_regular_user_requires_mention(self) -> None:
        message = types.SimpleNamespace(
            reply_to_message=types.SimpleNamespace(
                from_user=types.SimpleNamespace(id=42, username="alice", is_bot=False),
        ...
        self.assertTrue(group._reply_gate_requires_mention(message))
