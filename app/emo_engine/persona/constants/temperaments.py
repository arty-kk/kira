...
TEMPERAMENT_PROFILE: Dict[str, Dict[str, float]] = {
    "sanguine": {
        ...
        "precision": 0.95, "civility": 1.05, "dominance": 1.05,
    ...
    "choleric": {
        ...
        "charisma": 1.00, "persuasion": 1.25, "dominance": 1.20,
    },
    "melancholic": {
        "valence": 0.75, "arousal": 0.70, "engagement": 0.85,
        "sadness": 1.30, "fear": 1.15, "dominance": 0.85,
    ...
    "phlegmatic": {
        ...
        "friendliness": 1.20, "empathy": 1.20, "dominance": 0.90,
