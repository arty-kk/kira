...
_EN: Dict[str, str] = {
    ...
    "shop.title.gifts": "<b>🎁 Gamer-girl gifts</b>",
    ...
    # Gifts (titles)
    "gifts.matcha.title": "Matcha Latte",
    "gifts.plushie.title": "Kawaii Plushie",
    "gifts.keyboard_skin.title": "Keyboard Skin",
    "gifts.cat_headset.title": "Cat-Ear Headset",
    "gifts.game_pass.title": "Game Pass",
    "gifts.energy_drink.title": "Energy Drink Crate",
    "gifts.rgb_setup.title": "RGB Setup",
    "gifts.stream_throne.title": "Streamer Throne",
...
_RU: Dict[str, str] = {
    ...
    "shop.title.gifts": "<b>🎁 Gamer-girl набор</b>",
    ...
    # Gifts (titles)
    "gifts.matcha.title": "Матча-латте",
    "gifts.plushie.title": "Кавайный плюшик",
    "gifts.keyboard_skin.title": "Кейкап-скин",
    "gifts.cat_headset.title": "Наушники с кошачьими ушками",
    "gifts.game_pass.title": "Гейм-пасс",
    "gifts.energy_drink.title": "Ящик энергетиков",
    "gifts.rgb_setup.title": "RGB-сетап",
    "gifts.stream_throne.title": "Трон стримерши",
