...
from app.tasks.periodic import (
    ...
    payments_requeue_applied_unnotified_outbox_task, refunds_requeue_pending_outbox_task,
)
...
def start_scheduler() -> None:
    ...
    _sched.add_job(
        lambda: payments_requeue_applied_unnotified_outbox_task.delay(),
        "interval",
        minutes=3,
        id="payments_requeue_applied_unnotified_outbox_job",
        max_instances=1,
        coalesce=True,
        replace_existing=True,
        next_run_time=eager,
    ...
    _sched.add_job(
        lambda: refunds_requeue_pending_outbox_task.delay(),
        "interval",
        minutes=3,
        id="refunds_requeue_pending_outbox_job",
        max_instances=1,
        coalesce=True,
        replace_existing=True,
        next_run_time=eager,
