...
class Settings:
    ...
    WELCOME_MODEL: str = field(default_factory=lambda: _get_env("WELCOME_MODEL", "gpt-5-nano"))
    PING_MODEL: str = field(default_factory=lambda: _get_env("PING_MODEL", "gpt-5-nano"))
