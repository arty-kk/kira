...
class Settings:
    ...
    REASONING_MODEL: str = field(default_factory=lambda: _get_env("REASONING_MODEL", "gpt-5-nano"))
    RESPONSE_FREE_MODEL: str = field(default_factory=lambda: _get_env("RESPONSE_FREE_MODEL", "gpt-5.2"))
    RESPONSE_MODEL: str = field(default_factory=lambda: _get_env("RESPONSE_MODEL", "gpt-5.2"))
    RESPONSE_GROUP_MODEL: str = field(default_factory=lambda: _get_env("RESPONSE_GROUP_MODEL", "gpt-5.2"))
    ...
    RESPONSE_REASONING_EFFORT: str = field(default_factory=lambda: _get_env("RESPONSE_REASONING_EFFORT", "none", conv=str))
    RESPONSE_VERBOSITY: str = field(default_factory=lambda: _get_env("RESPONSE_VERBOSITY", "low", conv=str))
    POST_MODEL: str = field(default_factory=lambda: _get_env("POST_MODEL", "gpt-5-mini"))
    ...
    MODERATOR_ADMIN_CACHE_TTL_SECONDS: int = field(default_factory=lambda: _get_env("MODERATOR_ADMIN_CACHE_TTL_SECONDS", "604800", conv=int))
    MODERATOR_NOTIFICATION_CHAT_ID: int = field(default_factory=lambda: _get_env("MODERATOR_NOTIFICATION_CHAT_ID", "0", conv=int))
    MODERATION_AI_THRESHOLD: float = field(default_factory=lambda: _get_env("MODERATION_AI_THRESHOLD", "0.7", conv=float))
    MODERATION_DELETE_BLOCKED: bool = field(default_factory=lambda: _get_env("MODERATION_DELETE_BLOCKED", "true", conv=_parse_bool))
    MODERATION_DELETE_FLAGGED: bool = field(default_factory=lambda: _get_env("MODERATION_DELETE_FLAGGED", "false", conv=_parse_bool))
    ...
    MODERATION_AI_ENABLED_CATEGORIES: List[str] = field(default_factory=lambda: [x.strip().lower() for x in _get_env("MODERATION_AI_ENABLED_CATEGORIES", "sexual,sexual/minors,harassment/threatening,hate/threatening,illicit/violent,self-harm/instructions,violence/graphic").split(",") if x.strip()])
    MODERATION_AI_NSFW_THRESHOLD: float = field(default_factory=lambda: _get_env("MODERATION_AI_NSFW_THRESHOLD", "0.6", conv=float))
    ...
    MODERATION_PROFILE_NSFW_CACHE_SECONDS: int = field(default_factory=lambda: _get_env("MODERATION_PROFILE_NSFW_CACHE_SECONDS", "172800", conv=int))
    MODERATION_PROFILE_NSFW_MIN_CONFIDENCE: int = field(default_factory=lambda: _get_env("MODERATION_PROFILE_NSFW_MIN_CONFIDENCE", "40", conv=int))
    ...
    # filters
    MODERATION_EDITED_DELETE: bool = field(default_factory=lambda: _get_env("MODERATION_EDITED_DELETE",                   "false",  conv=_parse_bool))
    ...
    MODERATION_VIDEOS_DELETE:          bool = field(default_factory=lambda: _get_env("MODERATION_VIDEOS_DELETE",          "false",  conv=_parse_bool))
    MODERATION_GIFS_DELETE:            bool = field(default_factory=lambda: _get_env("MODERATION_GIFS_DELETE",            "false",  conv=_parse_bool))
    MODERATION_STORIES_DELETE:         bool = field(default_factory=lambda: _get_env("MODERATION_STORIES_DELETE",         "false",  conv=_parse_bool))
    # forwards / external
    ...
    MEMORY_TTL_DAYS_LTM: int = field(default_factory=lambda: _get_env("MEMORY_TTL_DAYS_LTM", "90", conv=int))
    RERANK_ITEM_CHAR_LIMIT: int = field(default_factory=lambda: _get_env("RERANK_ITEM_CHAR_LIMIT", "400", conv=int))
    LLM_TIMEOUT: float = field(default_factory=lambda: _get_env("LLM_TIMEOUT", "30.0", conv=float))
    ...
    SNIPPETS_MAX_TOKENS_GROUP: int = field(default_factory=lambda: _get_env("SNIPPETS_MAX_TOKENS_GROUP", "180", conv=int))
    #STM (Short-Term Context Memory)
    STM_TOKEN_BUDGET: int = field(default_factory=lambda: _get_env("STM_TOKEN_BUDGET", "5000", conv=int))
    STM_PAIR_LIMIT_PRIVATE: int = field(default_factory=lambda: _get_env("STM_PAIR_LIMIT_PRIVATE", "50", conv=int))
    ...
    GROUP_STM_TOKEN_BUDGET: int = field(default_factory=lambda: _get_env("GROUP_STM_TOKEN_BUDGET", "2600", conv=int))
    ...
    GROUP_RECENT_TOKENS_BUDGET: int = field(default_factory=lambda: _get_env("GROUP_RECENT_TOKENS_BUDGET", "7000", conv=int))
    GROUP_STM_TAIL_TOKENS: int = field(default_factory=lambda: _get_env("GROUP_STM_TAIL_TOKENS", "3200", conv=int))
    GROUP_STM_TAIL_MAX_LINES: int = field(default_factory=lambda: _get_env("GROUP_STM_TAIL_MAX_LINES", "36", conv=int))
    #MTM (Mid-Term Context Memory)
    MTM_BUDGET_TOKENS_PRIVATE: int = field(default_factory=lambda: _get_env("MTM_BUDGET_TOKENS_PRIVATE", "28000", conv=int))
    MTM_BUDGET_TOKENS_GROUP: int = field(default_factory=lambda: _get_env("MTM_BUDGET_TOKENS_GROUP", "9000", conv=int))
    MTM_TRIM_CHUNK_TOKENS_PRIVATE: int = field(default_factory=lambda: _get_env("MTM_TRIM_CHUNK_TOKENS_PRIVATE", "6000", conv=int))
    MTM_TRIM_CHUNK_TOKENS_GROUP: int = field(default_factory=lambda: _get_env("MTM_TRIM_CHUNK_TOKENS_GROUP", "2200", conv=int))
    ...
    MTM_RECENT_TAIL_TOKENS: int = field(default_factory=lambda: _get_env("MTM_RECENT_TAIL_TOKENS", "18000", conv=int))
    MTM_SNIPPETS_MAX_TOKENS: int = field(default_factory=lambda: _get_env("MTM_SNIPPETS_MAX_TOKENS", "320", conv=int))
    ...
    MTM_RECENT_WINDOW_TOKENS: int = field(default_factory=lambda: _get_env("MTM_RECENT_WINDOW_TOKENS", "22000", conv=int))
    MTM_COMPOSE_TIMEOUT_SEC: float = field(default_factory=lambda: _get_env("MTM_COMPOSE_TIMEOUT_SEC", "30.0", conv=float))
    MTM_S1_CAND_MAX: int = field(default_factory=lambda: _get_env("MTM_S1_CAND_MAX", "20", conv=int))
    MTM_S1_RECENT_TAKE: int = field(default_factory=lambda: _get_env("MTM_S1_RECENT_TAKE", "12", conv=int))
    #LTM (Long-Term Context Memory)
    LTM_MAX_TOKENS_PRIVATE: int = field(default_factory=lambda: _get_env("LTM_MAX_TOKENS_PRIVATE", "7000", conv=int))
    LTM_MAX_TOKENS_GROUP: int = field(default_factory=lambda: _get_env("LTM_MAX_TOKENS_GROUP", "1800", conv=int))
    LTM_STAGE1_TOPN: int = field(default_factory=lambda: _get_env("LTM_STAGE1_TOPN", "20", conv=int))
    LTM_STAGE2_TOPN: int = field(default_factory=lambda: _get_env("LTM_STAGE2_TOPN", "5", conv=int))
    LTM_SUMMARY_PARTIAL_TRIGGER_TOKENS: int = field(default_factory=lambda: _get_env("LTM_SUMMARY_PARTIAL_TRIGGER_TOKENS", "2000", conv=int))
    LTM_SNIPPETS_MAX_TOKENS: int = field(default_factory=lambda: _get_env("LTM_SNIPPETS_MAX_TOKENS", "260", conv=int))
    ...
    LTM_LLM_TOPN: int = field(default_factory=lambda: _get_env("LTM_LLM_TOPN", "8", conv=int))
    ...
    AUTOREPLY_GENERATION_RELEVANCE_THRESHOLD: float = field(default_factory=lambda: _get_env("AUTOREPLY_GENERATION_RELEVANCE_THRESHOLD", "0.72", conv=float))
