...
class Settings:
    ...
    MODERATION_MODEL: str = field(default_factory=lambda: _get_env("MODERATION_MODEL", "gpt-5-nano"))
    ...
    MODERATION_AI_REASONING_EFFORT: str = field(default_factory=lambda: _get_env("MODERATION_AI_REASONING_EFFORT", "low", conv=str))
